  ...
  module.exports = function(app, filters, base) {
    return function(env, callback) {
      return app(env, function() {
        var conditions, filter, filterCallback, original, proxiedCallback, _i, _len, _results;
        original = arguments;
        ...
        for (_i = 0, _len = filters.length; _i < _len; _i++) {
          ...
          if (passes(env, conditions)) {
            _results.push(context.wrap(filterCallback, base)(env, proxiedCallback));
          } else {
            callback.apply(null, original);
            break;
          }
        }
        return _results;
