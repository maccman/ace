...
(function() {
  ...
  sendFile = function(file, options) {
    ...
    if (options.lastModified) {
      this.headers['Last-Modified'] = options.lastModified;
    }
  ...
  basicAuth = function(callback, realm) {
    var auth, creds, pass, result, scheme, unauthorized, user, _ref, _ref1,
      _this = this;
    ...
    if (scheme.toLowerCase() !== 'basic') {
      return this.head(this.badRequest);
    }
    _ref1 = new Buffer(creds, 'base64').toString().split(':'), user = _ref1[0], pass = _ref1[1];
