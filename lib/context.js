...
(function() {
  var Context, strata, wait;

  strata = require('strata');

  wait = require('./async').wait;
  ...
  Context = (function() {
    ...
    Context.prototype.getter('cookies', function() {
      return wait(this.request.cookies.bind(this.request));
    });

    Context.prototype.getter('params', function() {
      return wait(this.request.params.bind(this.request));
    });

    Context.prototype.getter('query', function() {
      return wait(this.request.query.bind(this.request));
    });

    Context.prototype.getter('body', function() {
      return wait(this.request.body.bind(this.request));
    });
