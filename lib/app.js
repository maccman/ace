(function() {
  var App, context, fibers, filter, fs, method, methods, path, static, strata, templates,
  ...
  App = (function(_super) {
    ...
    function App() {
      ...
      this.settings.layout = templates.resolve(this.settings.layout, false);
    ...
    App.prototype.before = function(conditions, callback) {
      ...
      return this.use(filter, conditions, callback);
    };
